import { renameSync, rmSync, existsSync, readdirSync, readFileSync, writeFileSync, mkdirSync } from 'node:fs';
...
function waitForResponse(replyTo, timeoutMs = 30_000, pollMs = 200) {
    ensureBusDirs();
    cleanupBusStorage();
...
function claimNextRequest() {
    ...
    for (const fileName of files) {
        ...
        try {
            ...
            const envelope = readJsonFile(claimedPath);
