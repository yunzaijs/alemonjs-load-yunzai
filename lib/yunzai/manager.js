import { WORKER_PATH, YARN_PATH, getDefaultRepo, getGhProxy, getYunzaiDir } from "../path.js";
...
var YunzaiManager = class {
	...
	*/
	...
	validateRequiredPlugins() {
		...
		const isMiaoVariant = pkgName === "miao-yunzai" || pkgName === "miao_yunzai" || typeof pkg?.imports?.["#miao"] === "string" || typeof pkg?.imports?.["#miao.models"] === "string" || typeof pkg?.scripts?.ksr === "string";
		const missing = [];
