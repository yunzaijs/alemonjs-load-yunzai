...
import { detectYunzaiVariant, readYunzaiPackage } from "../yunzai/variant.js";
...
var pluginHelp_default = async (e) => {
	...
	const variant = yunzaiInstalled ? detectYunzaiVariant(readYunzaiPackage(yunzaiDir)) : void 0;
