import { migrateLegacyYunzaiDir } from "./path.js";
import { manager } from "./yunzai/manager.js";
import apiRouter from "./api-router.js";
import { bindApiRequestListener } from "./yunzai/bridge.js";
import "./yunzai/index.js";
...
var src_default = defineChildren({
	...
	async onCreated() {
		...
		if (migration.migrated) logger.info(`[Yunzai] 已将旧目录 ${migration.source} 迁移为固定目录 ${migration.target}`);
		...
		} else logger.info("[Yunzai] 未安装。发送 #yz安装 安装机器人，安装后可通过 #yz安装<插件名> 添加插件");
	}
});
